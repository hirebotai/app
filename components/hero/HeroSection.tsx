                ...
                <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setShowOsModal(false)}>
                  <div className="bg-surface-900 border border-brand-500/30 rounded-2xl p-6 sm:p-8 max-w-md w-full space-y-6 shadow-2xl animate-in fade-in zoom-in" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="space-y-3">
                      <a href={process.env.NEXT_PUBLIC_DOWNLOAD_URL || 'https://github.com/hirebotai/app/releases/download/v1.17.8.26/HireBotAi_Windows.zip'} onClick={() => { trackWindowsDownload(); setShowOsModal(false); }} className="flex items-center justify-between p-4 rounded-xl bg-surface-950 border border-surface-800 hover:border-brand-400 transition-all group">
