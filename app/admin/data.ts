...
export const seedApps: AppItem[] = [
  {
    ...
    downloadUrl: 'https://github.com/hirebotai/app/releases/download/v1.17.8.26/HireBotAi_Install_Package.zip',
    totalDownloads: 342,
    status: 'published',
  ...
  },
  {
    ...
    websiteUrl: 'https://hirebotai.in',
    latestVersion: '1.17.8.26',
    downloadUrl: 'https://github.com/hirebotai/app/releases/download/v1.17.8.26/Hirebotai-mac.zip',
    totalDownloads: 87,
    status: 'published',
